...
const zhCN: LocaleStrings = {
  ...
  "syncPlan.migrationSummary": "正在升级这台设备的同步状态。建议先更新其他设备上的 EasySync，再继续操作。",
  "syncPlan.cloudJoinSummary": "这台设备正在加入已有同步状态。确认计划后，EasySync 会先建立本机同步状态，再按计划同步文件。",
  "syncPlan.confirmMigration": "继续升级并同步",
  "syncPlan.migrationConfirmTitle": "升级这台设备的同步状态",
  "syncPlan.migrationConfirmMessage": "这台设备将改用新的同步状态。建议先更新其他使用此仓库的设备；长期离线的旧版本设备无法被自动发现。",
  "syncPlan.migrationConfirmWarning": "如果旧版本设备之后写入变化，EasySync 会将其作为普通外部变化重新核对。请尽快更新所有设备。",
  "syncPlan.migrationConfirm": "继续升级并同步",
  ...
  "syncView.recovery.detail.retryAt": "{remaining} 项仍待核对，将于 {time} 再次核对",
  ...
  "syncView.communityPlugins.pendingTitle": "社区插件启用状态待确认（{count}）",
  "syncView.communityPlugins.pendingDescription": "本机与远端首次出现不同状态，请选择要保留的一侧。",
