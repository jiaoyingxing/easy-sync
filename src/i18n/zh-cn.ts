...
const zhCN: LocaleStrings = {
  ...
  "settings.pluginSyncMode.name": "插件同步粒度",
  "settings.pluginSyncMode.desc": "控制社区插件的代码文件按什么范围同步。仅当「社区插件」开启时生效。",
  "settings.pluginSyncMode.all": "同步全部",
  "settings.pluginSyncMode.whitelist": "仅同步勾选的插件",
  "settings.pluginSyncMode.blacklist": "同步除勾选外的所有插件",
  "settings.pluginSyncMode.pluginList": "插件列表",
  "settings.pluginSyncMode.noPlugins": "未检测到已安装的社区插件",
  "settings.pluginSyncMode.depHint": "注意：仅同步插件 A 而不同步其依赖插件 B，可能导致 A 功能异常。",
