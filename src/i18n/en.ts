...
const en: LocaleStrings = {
  ...
  "settings.pluginSyncMode.name": "Plugin sync granularity",
  "settings.pluginSyncMode.desc": "Control which community plugins' code files are synced. Only takes effect when \"Community plugins\" is enabled.",
  "settings.pluginSyncMode.all": "Sync all",
  "settings.pluginSyncMode.whitelist": "Only sync checked plugins",
  "settings.pluginSyncMode.blacklist": "Sync all except checked plugins",
  "settings.pluginSyncMode.pluginList": "Plugin list",
  "settings.pluginSyncMode.noPlugins": "No community plugins detected",
  "settings.pluginSyncMode.depHint": "Note: syncing plugin A without its dependency B may cause A to malfunction.",
