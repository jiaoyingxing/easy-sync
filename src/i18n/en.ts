...
const en: LocaleStrings = {
  ...
  "settings.communityPlugins.decisions.state": "Local: {local} · Remote: {remote}",
  ...
  "syncPlan.migrationSummary": "EasySync is upgrading this device's sync state. Update EasySync on other devices first when possible, then continue.",
  ...
  "syncPlan.migrationConfirmTitle": "Upgrade this device's sync state",
  "syncPlan.migrationConfirmMessage": "This device will switch to the new sync state. Update EasySync on other devices using this vault first when possible; old versions on long-offline devices cannot be discovered automatically.",
  "syncPlan.migrationConfirmWarning": "If an old-version device writes changes later, EasySync will recheck them as ordinary external changes. Update all devices as soon as practical.",
  "syncPlan.migrationConfirm": "Continue upgrade & sync",
  ...
  "syncView.recovery.detail.retryAt": "{remaining} item(s) still need checking; checking again at {time}",
  ...
  "syncView.communityPlugins.pendingTitle": "Community plugin enabled state needs review ({count})",
  "syncView.communityPlugins.pendingDescription": "Local and remote differ on first observation. Choose which side to keep.",
